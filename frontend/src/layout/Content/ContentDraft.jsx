...
const ContentDraft = () => {
  ...
  async function generateAnswerWithQuestion(e, questionText) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyD8iu02nKwBh3mZhGqCdU2qCr-ey33n0vc`,
        method: "post",
        data: {
  ...
  async function generateAnswer2WithQuestion(e, questionText) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro-latest:generateContent?key=AIzaSyD8iu02nKwBh3mZhGqCdU2qCr-ey33n0vc`,
        method: "post",
        data: {
          contents: [{ parts: [{ text: questionText }] }],
        },
  ...
  async function generateAnswer9WithQuestion(e, questionText) {
    ...
    try {
      ...
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro:generateContent?key=AIzaSyD8iu02nKwBh3mZhGqCdU2qCr-ey33n0vc`,
        method: "post",
        data: {
